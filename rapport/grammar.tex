...
<assignment> 	::= ( esp set esp id esp <expr> esp ) | ( esp set esp id . <expr> esp <expr> ) | ( esp set esp this . <expr> esp <expr> esp )
...
<expr> 		::=  <call>  | <number> | null | true | false | this | id | id.<expr> | this.<expr>
\end{verbatim}
