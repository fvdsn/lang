...
public class SyntaxParser {
	...
	private parser lexParser;
	private Hashtable<Term,Hashtable<Term,String>> table;
	private List<Rule> grammar;
	private Term tree = null;
	public SyntaxParser(parser lexParser, List<Rule> grammar){
		this.grammar = grammar;
		this.lexParser = lexParser;
		CheckPrecedence.precTable(grammar, table);
	}
	...
	public String prec(int i, int j){
		return table.get(stack.get(i)).get(stack.get(j));
	}
